...
router = APIRouter(prefix="/reviews", tags=["Reviews"]) # All endpoints will start with /catalog and tagged as Catalogs
...
async def review_book_router (
    book_id: str,
    registry_data: ReviewData, # Pseudo model for book registration form
    request: Request,
