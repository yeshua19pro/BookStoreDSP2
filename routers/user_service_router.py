...
from models.user_service_models import (LoginForm, TokenResponse, RegisterForm, TokenResponse) # Validation models for auth (Account creation, login, token response)       
from services.user_service import register_user, create_access_token, login_user, verify_password, hash_password # Auxiliar functions for routers
...
import random 
from utils.time import utc_now # Router functions for lesser verbouse text
